...
class Lot {
    ...
    load(config, dynamicConstructors) {
...
class Building {
    constructor(config, components, roofMesh) {
    ...
    loadWalls(config) {
        ...
        if (isWallsArray) {
            this.floorBasedWallConstraint = new Array();
    ...
    getBuildCommandsForSide(lotSide, window, wall) {
    ...
    constructLot(lotGenerateConfig) {
    ...
    construct(rootTranslation, shapeGrammar, generationConstraint, property) {
